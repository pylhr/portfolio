      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex items-center bg-gray-100 rounded-lg p-6">
            ...
            <div>
              <a href="YOUR_LINKEDIN_PROFILE_URL" target="_blank" rel="noopener noreferrer" className="text-lg font-semibold text-gray-800 hover:text-blue-600">Connect with me on LinkedIn</a>
          ...
          <div className="flex items-center bg-gray-100 rounded-lg p-6">
            ...
            <div>
              <a href="YOUR_INSTAGRAM_PROFILE_URL" target="_blank" rel="noopener noreferrer" className="text-lg font-semibold text-gray-800 hover:text-purple-600">Follow me on Instagram</a>
          ...
          <div className="flex items-center bg-gray-100 rounded-lg p-6">
            ...
            <div>
              <a href="YOUR_YOUTUBE_CHANNEL_URL" target="_blank" rel="noopener noreferrer" className="text-lg font-semibold text-gray-800 hover:text-red-600">Subscribe to my YouTube channel</a>
          ...
          <div className="flex items-center bg-gray-100 rounded-lg p-6">
            ...
            <div>
              <a href="mailto:YOUR_EMAIL_ADDRESS" className="text-lg font-semibold text-gray-800 hover:text-green-600">Send me an email</a>
